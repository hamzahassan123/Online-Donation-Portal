...
import MobileApp from "../img/app-iPhone.png";
import DownloadApp from "../img/download-app-android.png";
    ...
    <>
      <section class="text-gray-600 body-font">
        <div class="text-center mb-10 ">
          <h1 class="sm:text-3xl text-2xl font-medium title-font text-gray-900 mb-4 mt-20">
            How it works — Simple as 1, 2, 3
          </h1>
          <p class="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto text-gray-500s">
            Follow these steps to understand the working of our app.
          </p>
        </div>
          ...
          <div class="flex relative pb-20 sm:items-center md:w-2/3 mx-auto">
            ...
            <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
              ...
              <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                ...
                <p class="leading-relaxed">
                  Register your self to perform usable actions.
                </p>
              </div>
            </div>
          </div>
          <div class="flex relative pb-20 sm:items-center md:w-2/3 mx-auto">
            ...
            <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
              ...
              <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                ...
                <p class="leading-relaxed">
                  If you want to donate medicine or money donate there.
                </p>
              </div>
            </div>
          </div>
